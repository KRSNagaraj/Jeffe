...
namespace Jeff_ProcessFiles
{
    public class RunJob
    {
        ...
        private static string BatchAccountName = "myfirstbatch01";
        private static string BatchAccountKey = "VPQlnTr9hpqEl1MCL8VTr8slng7tZDl2UP6MDnbwevRdyzXwJAw5wdwRCcz6xxvBsoY47eYXUgPgJyPREtevQw==";
        private static string BatchAccountUrl = "https://myfirstbatch01.northeurope.batch.azure.com";
        ...
        private static void LoadConfig()
        {
            ...
            BatchAccountUrl = ConfigurationManager.AppSettings["BatchServiceUrl"];
        ...
        private static string GetContainerSasUrl(CloudBlobClient blobClient, string containerName, SharedAccessBlobPermissions permissions)
        {
            ...
            {
                SharedAccessStartTime = DateTime.UtcNow.AddHours(-12),
        ...
        private static async Task<ResourceFile> UploadFileToContainerAsync(CloudBlobClient blobClient, string containerName, string filePath)
        {
            ...
            SharedAccessBlobPolicy sasConstraints = new SharedAccessBlobPolicy
            {
                SharedAccessStartTime = DateTime.UtcNow.AddHours(-16),
        ...
        private static async Task CreatePoolIfNotExistAsync(BatchClient batchClient, string poolId, IList<ResourceFile> resourceFiles)
        {
            ...
            try
            {
                ...
                pool = batchClient.PoolOperations.CreatePool(
                    poolId: poolId,
                    targetDedicated: ComputeNode,                                                         // 3 compute nodes
                    virtualMachineSize: vmSize,                                                // single-core, 1.75 GB memory, 225 GB disk
                    cloudServiceConfiguration: new CloudServiceConfiguration(osFamily: "4"));   // Windows Server 2012 R2
                pool.MaxTasksPerComputeNode = TaskPerNode;
